...
namespace NippoControlSystem.UI.Views
{
    class Views
    {
        ...
        MainView m_frmMain = null;
        DataInputView m_frmDataInput = null;
        DebugView m_frmDebug = null;
        DebugNoView m_frmDebugNo = null;
        OpeningView m_frmOpenning = null;
        PinAnalogInputView m_frmPinAi = null;
        PinAnalogOutputView m_frmPinAo = null;
        PinInputOutput m_frmPinIO = null;
        PinNameView m_frmPinName = null;
        PortView m_frmPort = null;
        ResultView m_frmResultView = null;
        SerialView m_frmSerial = null;
        SettingView m_frmSetting = null;
        TopEditView m_frmTopEdit = null;
        TopEditCopyView m_frmTopEditCopy = null;
        TopEditInputView m_frmTopEditInput = null;
        VersionView m_frmVersion = null;
        //frmAIOMonitor m_frmAIOMonitor = null;
        //frmPinAoMonitor m_frmPinAoMonitor = null;
        TestHistoryView m_frmHistView = null;

        //--------1---------2---------3---------4---------5---------6---------7---------8
        //メンバ変数：設定格納変数
        private static Views m_instance = null;
        public static Views GetInstance()
        {
            if (m_instance == null)
            {
                m_instance = new Views();
            }
            return m_instance;
        }
        ...
        public DataInputView fmDataInput
        {
        ...
        //--------1---------2---------3---------4---------5---------6---------7---------8
        //プロパティ m_frmPinAit
        public PinAnalogInputView fmPinAi
        {
        ...
        //--------1---------2---------3---------4---------5---------6---------7---------8
        //プロパティ m_frmPinAo
        public PinAnalogOutputView fmPinAo
        {
        ...
        //--------1---------2---------3---------4---------5---------6---------7---------8
        //プロパティ fmResultView
        public ResultView fmResultView
        {
        ...
        public TopEditCopyView fmTopEditCopy
        {
        ...
        public TopEditInputView fmTopEditInput
        {
        ...
        //--------1---------2---------3---------4---------5---------6---------7---------8
        //プロパティ frmHist
        public TestHistoryView fmHistView
        {
