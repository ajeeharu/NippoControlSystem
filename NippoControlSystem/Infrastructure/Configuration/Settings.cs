...
namespace NippoControlSystem.Infrastructure.Configuration
{
    public class Settings
    {
        ...
        public Log.LogLevel AI2DI_LogLevel { get; set; }
        ...
        public Settings()
        {
            ...
            AI2DI_LogLevel = Log.LogLevel.LOG_INFO;
            AI2DI_AveTimes = 10;
            AI2DI_VoltMin = -10.0f;
