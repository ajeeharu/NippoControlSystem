...
{
    public partial class DebugNoView : Form
    {
        ...
        public DebugNoView(AnalogIO aio)
        {
            _aio = aio;
            InitializeComponent();
        }
        ...
        private void frmDebugNo_Load(object sender, EventArgs e)
        {
            ...
            Views.DesktopLocation((Form)this, System.Configuration.ConfigurationManager.AppSettings["loc_frmDebugNo"]);
