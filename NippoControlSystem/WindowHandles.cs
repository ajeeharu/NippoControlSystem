...
static class WindowsHandles
{
    ...
    // タイトル存在チェック OG追加
    public static IntPtr GethWndExistsTitle(string title)
    {
        bool result = false;
    ...
    // タイトル存在チェック OG追加
    public static IntPtr GethWndExistsClassName(string ClassName)
    {
        bool result = false;
        IntPtr hWnd = IntPtr.Zero;
